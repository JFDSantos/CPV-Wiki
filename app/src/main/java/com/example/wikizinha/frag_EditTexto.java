...
public class frag_EditTexto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frag_edit_texto);
        ...
        txtTitulo.setText(noteTitle);
        txtConteudo.setText(noteContent);
    }
    ...
    public void BtnSalvarEditTexto(View view){
        ...
        //salvar texto
            ...
            //Edit em seus artigos
                    DocumentReference documentReferenceAll = db.collection("notes").document(data.getStringExtra("noteId"));
                    Map<String,Object> note = new HashMap<>();
                    note.put("titulo",nTitulo);
                    note.put("conteudo",nConteudo);
                    documentReferenceAll.update(note).addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
    ...
    public void Voltar() {
        Intent intent = new Intent (frag_EditTexto.this, MainActivity.class);
